...
function cambiarInstanciaDado() {
    ...
    switch (instanciaDeJuegoDado) {
        ...
        case 2: // Elegir apuesta viendo tus tres dados
            columna_uno.innerHTML = `
            <div class="cuadrosDeInfo">
                <h4>CONTADOR</h4>
               <p>
        ...
        case 6: //instrucciones del juego de dados
            columna_dos.innerHTML = `
            <h3>Instrucciones</h3>
            <ul>
            <li>Se juega con 3 grupos de 6 dados (cada numero se puede repetir 3 veces). Cada numero tiene su valor en puntos</li>
            <li>Al iniciar un nuevo turno, cada jugador recibe 3 dados al azar y debe decidir la cantidad de puntos a apostar. Puede apostar 5, 10 o 15 puntos.</li>
            <li>El turno tiene 3 rondas. En cada ronda los jugadores tiran un dado y gana la ronda quien haya tirado el dado de mayor valor. En la siguiente ronda se repite la mecánica con los dados restantes. En la tercera ronda se repite la mecánica con el último dado que tiene cada jugador. </li>
        ...
        case 7: //Enfrentamiento de dos dados
